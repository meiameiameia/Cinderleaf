...
class MainWindow(QMainWindow):
    ...
    def _build_inventory_sandbox_sync_actions_widget(self) -> QFrame:
        ...
        buttons_column.addWidget(self._sync_selected_to_sandbox_button)
        buttons_column.addWidget(self._promote_selected_to_real_button)
    ...
    def _build_inventory_real_profile_actions_widget(self) -> QFrame:
        ...
        layout.addWidget(self._real_profile_combo)
        actions_row = QHBoxLayout()
        actions_row.setContentsMargins(0, 0, 0, 0)
        actions_row.setSpacing(8)
        actions_row.addWidget(self._create_real_profile_button)
    ...
    def _build_inventory_sandbox_profile_actions_widget(self) -> QFrame:
        ...
        layout.addWidget(self._sandbox_profile_combo)
        actions_row = QHBoxLayout()
        actions_row.setContentsMargins(0, 0, 0, 0)
        actions_row.setSpacing(8)
        actions_row.addWidget(self._create_sandbox_profile_button)
