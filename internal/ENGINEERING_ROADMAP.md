...
Last refreshed: `2026-04-07` after update-cache work, startup auto-check, diagnostics, packages/archive improvements, cold update-check concurrency, and twelve layout/build extraction passes
